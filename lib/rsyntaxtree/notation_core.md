...
What is above is the part of the notation that is easy to get wrong, not the
whole of it. The rest is in the manual, and every example in the gallery is
written out beside the figure it draws:
